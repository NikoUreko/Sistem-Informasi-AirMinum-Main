...
@section('title')
Tambah Kos | Chillin'Vibe Admin
@endsection

@section('content')
<h3>Input Data Kos</h3>
<div class="form-login">
  <form action="{{ url('/kos/store') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <label for="pemakaian_level_1">Pemakaian (0-20m³)</label>
    <input class="input-readonly" type="number" name="pemakaian_level_1" id="pemakaian_level_1" placeholder="0-20m³" value="{{ old('pemakaian_level_1') }}" readonly />
    <p class="tarif-label">Tarif I: Rp <span id="tarif_1_display" class="tarif-value">0</span></p>
    @error('pemakaian_level_1')
    <p style="font-size: 10px; color: red">{{ $message }}</p>
    @enderror

    <label for="pemakaian_level_2">Pemakaian (21-40m³)</label>
    <input class="input-readonly" type="number" name="pemakaian_level_2" id="pemakaian_level_2" placeholder="21-40m³" value="{{ old('pemakaian_level_2') }}" readonly />
    <p class="tarif-label">Tarif II: Rp <span id="tarif_2_display" class="tarif-value">0</span></p>
    @error('pemakaian_level_2')
    <p style="font-size: 10px; color: red">{{ $message }}</p>
    @enderror

    <label for="pemakaian_level_3">Pemakaian (>41m³)</label>
    <input class="input-readonly" type="number" name="pemakaian_level_3" id="pemakaian_level_3" placeholder=">41m³" value="{{ old('pemakaian_level_3') }}" readonly />
    <p class="tarif-label">Tarif III: Rp <span id="tarif_3_display" class="tarif-value">0</span></p>
    @error('pemakaian_level_3')
    <p style="font-size: 10px; color: red">{{ $message }}</p>
    @enderror
    ...
    <span class="tambah_name">Simpan Data</span>
    </button>
