...
@section('title')
Administrasi Kos | HIPPAM Admin
@endsection

@section('content')
<h3>Administrasi Kos</h3>
...
<form action="{{ route('kos.index') }}" method="GET" class="search-form">
